...
* 会自然生成于[堡垒遗迹](https://minecraft.fandom.com/zh/wiki/%E5%A0%A1%E5%9E%92%E9%81%97%E8%BF%B9)里。
...
[绯红菌岩和诡异菌岩](https://minecraft.fandom.com/zh/wiki/%E8%8F%8C%E5%B2%A9)
...
[磁石](https://minecraft.fandom.com/zh/wiki/%E7%A3%81%E7%9F%B3)
...
[裂纹磨制黑石砖](https://minecraft.fandom.com/zh/wiki/%E8%A3%82%E7%BA%B9%E7%A3%A8%E5%88%B6%E9%BB%91%E7%9F%B3%E7%A0%96)
...
* 自然生成于下界的灵魂沙峡谷生物群系。
* 版本独有：每秒会造成1（![♥](https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/2/24/Half_Heart_\(icon\).png/revision/latest?cb=20200829145636)）伤害。
...
[标靶](https://minecraft.fandom.com/zh/wiki/%E6%A0%87%E9%9D%B6)
...
* 版本独有：拥有与Java版不同的纹理。
* 版本独有：无法附魔[消失诅咒](https://minecraft.fandom.com/zh/wiki/%E6%B6%88%E5%A4%B1%E8%AF%85%E5%92%92)。[\[2\]](https://minecraft.fandom.com/zh/wiki/%E5%9F%BA%E5%B2%A9%E7%89%881.16.0#cite_note-2)

[音乐唱片](https://minecraft.fandom.com/zh/wiki/%E9%9F%B3%E4%B9%90%E5%94%B1%E7%89%87)

* 加入了音乐唱片“Pigstep”。
  * 与其他的音乐唱片不同，这是由[Lena Raine](https://minecraft.fandom.com/zh/wiki/Lena_Raine)制作的而不是原唱片制作人[C418](https://minecraft.fandom.com/zh/wiki/C418)。
  * 只能在堡垒遗迹的战利品箱中发现。
...
* 生成于[下界](https://minecraft.fandom.com/zh/wiki/%E4%B8%8B%E7%95%8C)的熔岩海中。
  * 熔岩上方存在两格以上的空气才会生成。
  * 在熔岩外会打寒颤并变成暗紫色，面部表情稍微改变且移动速度减缓。[\[3\]](https://minecraft.fandom.com/zh/wiki/%E5%9F%BA%E5%B2%A9%E7%89%881.16.0#cite_note-3)
...
[生物群系](https://minecraft.fandom.com/zh/wiki/%E7%94%9F%E7%89%A9%E7%BE%A4%E7%B3%BB)
...
* 加入了6种表情。
* 在游戏中，默认情况下，可以通过按下键盘上的B键、Xbox One控制器的![D-Pad left](https://static.wikia.nocookie.net/ucp-internal-test-starter-commons/images/4/41/XboxOne_Left.png/revision/latest/scale-to-width-down/30?cb=20200818142851)、Nintendo Switch控制器的![Left button](https://static.wikia.nocookie.net/ucp-internal-test-starter-commons/images/1/1c/Switch_Button_Left.png/revision/latest/scale-to-width-down/30?cb=20200818142927)/![D-Pad left](https://static.wikia.nocookie.net/ucp-internal-test-starter-commons/images/9/9e/Switch_Left.png/revision/latest/scale-to-width-down/30?cb=20200818143421)或PlayStation 4控制器的![D-Pad left](https://static.wikia.nocookie.net/ucp-internal-test-starter-commons/images/b/b6/PS4_Left.png/revision/latest/scale-to-width-down/25?cb=20200818143500)或在触摸屏上点击屏幕上方的[![Emote button BE1](https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/b/b1/Emote_button_BE1.png/revision/latest/scale-to-width-down/20?cb=20200426115406)](https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/b/b1/Emote_button_BE1.png/revision/latest?cb=20200426115406)按钮来进入表情选择界面。
...
* 现在会给予附近雨中的玩家[潮涌能量](https://minecraft.fandom.com/zh/wiki/%E6%BD%AE%E6%B6%8C%E8%83%BD%E9%87%8F)。
...
[潜影盒](https://minecraft.fandom.com/zh/wiki/%E6%BD%9C%E5%BD%B1%E7%9B%92)
...
* 被治愈的僵尸村民现在会为交易打折。[\[5\]](https://minecraft.fandom.com/zh/wiki/%E5%9F%BA%E5%B2%A9%E7%89%881.16.0#cite_note-5)

[卫道士](https://minecraft.fandom.com/zh/wiki/%E5%8D%AB%E9%81%93%E5%A3%AB)

* 在[林地府邸](https://minecraft.fandom.com/zh/wiki/%E6%9E%97%E5%9C%B0%E5%BA%9C%E9%82%B8)中生成的卫道士现在呈敌对状态。[\[6\]](https://minecraft.fandom.com/zh/wiki/%E5%9F%BA%E5%B2%A9%E7%89%881.16.0#cite_note-6)

[狼](https://minecraft.fandom.com/zh/wiki/%E7%8B%BC)

* 现在会生成于[森林](https://minecraft.fandom.com/zh/wiki/%E6%A3%AE%E6%9E%97)和[巨型针叶林](https://minecraft.fandom.com/zh/wiki/%E5%B7%A8%E5%9E%8B%E9%92%88%E5%8F%B6%E6%9E%97)生物群系。[\[7\]](https://minecraft.fandom.com/zh/wiki/%E5%9F%BA%E5%B2%A9%E7%89%881.16.0#cite_note-7)
...
* 更改了[村民](https://minecraft.fandom.com/zh/wiki/%E6%9D%91%E6%B0%91)的交易内容与价格以近似匹配[Java版](https://minecraft.fandom.com/zh/wiki/Java%E7%89%88)。[\[8\]](https://minecraft.fandom.com/zh/wiki/%E5%9F%BA%E5%B2%A9%E7%89%881.16.0#cite_note-8)
...
* 游戏不再会在末影龙重生时使用`/`[`kill`](https://minecraft.fandom.com/zh/wiki/%E5%91%BD%E4%BB%A4/kill)时崩溃。
* 修复了若干游戏过程中可能发生的崩溃。
...
* 混淆的文本样式代码会正常工作于放置在世界中的牌子了。（[MCPE-33780](https://bugs.mojang.com/browse/MCPE-33780)）
...
* 蓝色凋灵之首现在会再次破坏黑曜石了。（[MCPE-63223](https://bugs.mojang.com/browse/MCPE-63223)）
...
* 村民不会一直分享胡萝卜了。（[MCPE-32627](https://bugs.mojang.com/browse/MCPE-32627)）
* 生成在林地府邸的卫道士现在会使用生成事件，并会在受到攻击之前变得敌对了。（[MCPE-43208](https://bugs.mojang.com/browse/MCPE-43208)）
* 村民现在有机会出售三叉戟的附魔书了。（[MCPE-35406](https://bugs.mojang.com/browse/MCPE-35406)）
* 在与玩家同一条船上的苦力怕会给玩家造成伤害了。
* 狼能够再次通过喂食恢复生命值了。（[MCPE-63205](https://bugs.mojang.com/browse/MCPE-63205)）
* 苦力怕不再在丢失对象视线后立即失去仇恨了。（[MCPE-32815](https://bugs.mojang.com/browse/MCPE-32815)）
* 恶魂的碰撞箱现在匹配渲染的样子了。（[MCPE-44326](https://bugs.mojang.com/browse/MCPE-44326)）
* 修复了“近战攻击目标”允许实体攻击它们下方的实体。
* 削减了实体的近战攻击范围。（[MCPE-48539](https://bugs.mojang.com/browse/MCPE-48539)）
* 修复了一个有时阻止生物在下台阶上着火的漏洞。（[MCPE-32822](https://bugs.mojang.com/browse/MCPE-32822)）
* 海龟能够正确下蛋了。（[MCPE-59043](https://bugs.mojang.com/browse/MCPE-59043)）
* 守卫者现在能够生成在气泡柱里了。（[MCPE-37671](https://bugs.mojang.com/browse/MCPE-37671)）
* 修复了一个导致恼鬼在X和Z轴上移动速度过慢的漏洞。（[MCPE-41879](https://bugs.mojang.com/browse/MCPE-41879)）
* 愤怒的蜜蜂现在飞的更慢了。（[MCPE-53689](https://bugs.mojang.com/browse/MCPE-53689)）

方块

* 墙不再在垂直堆叠的时候出现缝隙了。
* 活板门的碰撞箱现在匹配它们的视觉形状了。（[MCPE-13451](https://bugs.mojang.com/browse/MCPE-13451)）
* 画不再能够放置在物品展示框的顶部了。
* 仙人掌方块现在会在贴近熔岩时被破坏了。
* 在雪里的花现在会被正确的破坏并掉落正确的物品了。（[MCPE-30147](https://bugs.mojang.com/browse/MCPE-30147)）
* 下落的方块不再会在掉落在冰和玻璃上时被破坏了。
* 下落的方块现在会被活塞臂上的不完整方块破坏了。
* 菌丝体现在不会再由于没有充足的光照而错误地转换为泥土了。
* 附在门上的告示牌不再在门的下半部分被破坏时漂浮了。（[MCPE-43748](https://bugs.mojang.com/browse/MCPE-43748)）
* 平滑的石英块现在有了正确的纹理。（[MCPE-42276](https://bugs.mojang.com/browse/MCPE-42276)）
* 使用精准采集破坏巨型蘑菇现在会掉落正确的方块了。（[MCPE-34114](https://bugs.mojang.com/browse/MCPE-34114)）.

控制

* 使用手柄时，生命值会出现在物品栏中。控件现在更加用户友好，更类似于使用鼠标和键盘玩法那样。（[MCPE-34912](https://bugs.mojang.com/browse/MCPE-34912)）
* 现在玩家可以在水中按住下沉按钮的同时向下游泳了。
* 在水下起床的时候控件配置会自动切换到游泳时出现的控件了。（[MCPE-49632](https://bugs.mojang.com/browse/MCPE-49632)）

声音

* 使用鞘翅高速飞行不再导致鞘翅的声音变得卡顿了。（[MCPE-19945](https://bugs.mojang.com/browse/MCPE-19945)）
...
* 修复了市场中的“浏览”导航箭头。
* 修复了iOS键盘在输入的时候覆盖文本输入框的问题。（[MCPE-53030](https://bugs.mojang.com/browse/MCPE-53030)）
...
* 未装载的弩不再在物品栏中展示错误的图标。（[MCPE-53545](https://bugs.mojang.com/browse/MCPE-53545)）

命令

* 更新了`/`[`scoreboard`](https://minecraft.fandom.com/zh/wiki/%E5%91%BD%E4%BB%A4/scoreboard)命令介绍的语法以与其他的命令同步。
* 使用`/`[`effect`](https://minecraft.fandom.com/zh/wiki/%E5%91%BD%E4%BB%A4/effect)造成的瞬间效果现在使用刻而不是秒了。（[MCPE-43393](https://bugs.mojang.com/browse/MCPE-43393)）
* 物品的标签现在可以被`/`[`gamerule`](https://minecraft.fandom.com/zh/wiki/%E5%91%BD%E4%BB%A4/gamerule) `showtags`切换在UI上的显示了。

附加包和脚本

* 实现了一个修复来确认玩家骑乘所有载具更新状态以确认一致性的平滑旋转。
* `delayed_attack`行为不再导致生物在丢失对象的时候不动了。
* `on_unleash`事件现在会在从拴在栅栏到变为脱离时正确触发了。
* “创建新的世界”按钮文本现在使用全局色彩组件了。
* 现在自定义实体运行时标识符字段使用自定义实体的名称而非原始实体的名称了。（[MCPE-56229](https://bugs.mojang.com/browse/MCPE-56229)）
* 修复了`circle_around_anchor`的行为，它会导致生物在方块附近停住。
* 喷溅药水和滞留药水现在在它们各自的弹射物组件里有了对应的药水效果了。
* `damage_sensor`组件现在会在非生物对象（例如末地水晶）上生效了。
* 一个生成在空气中的生物一旦移动刻被触发就不再会认为自己还在地面上了。
* 实体不再在移除包含导航组件的事件组的时候不动了。
* 移除了`minecraft:shooter`未被使用的类型事件。
* 更新了`minecraft:spawn_entity`使其能够拥有一个内部实体对象或者数组。
* 更新了`minecraft:behavior.circle_around_anchor`的行为。
* 为`minecraft:behavior.defend_village_target`目标添加了`attack_chance`。
* 修复了已移除或破坏的实体在脚本中请求有效的问题。
* `minecraft:spawn_entity`域里的`spawn_item`里的非法物品现在会提示一个错误了。
* `StompEggGoal`不再使用`search_count`，因为它现在会搜索特定区域内的所有方块了。
* 修复了`navigation.walk`用于处理将其用于飞行实体的情况，以使飞行实体在接触地面时不会引起卡顿。
* “生成规则”文档部分中现在记录了`minecraft:density_limit`组件的用法。（[MCPE-61126](https://bugs.mojang.com/browse/MCPE-61126)）
* 当玩家定义了一个非法的物品名到`transform_to_item`域里的`minecraft:interact`时候会出现一个内容错误提示了。
* 使用渲染控制器切换其他几何图形即可立即在游戏中更改了。
* 修复了使用空的标签作为参数时选择器@e\[tag=]和@e\[tag=!]的问题。
* AvoidMobTypeDefinition和转换后的硬编码属性现在是数据驱动的了。
* 添加了`minecraft:density_limit`的文档。（[MCPE-61126](https://bugs.mojang.com/browse/MCPE-61126)）
* 为过滤器添加了新的项目，使得`damage_sensor`能够过滤弹射物。
* 修复了一个自定义酿造配方的问题。
...
* 修复了一个有关某些角色创建者选项不会在会话之间保存的问题。（[MCPE-32089](https://bugs.mojang.com/browse/MCPE-32089)）
